...
const AdminDashboard = () => {
  ...
  const buscarUsuariosLogados = async () => {
    try {
      const response = await axios.get('https://fisiopilattes-production.up.railway.app/usuarios/logados'); // Substitua com a rota do seu backend
  ...
  const buscarUsuarioPorId = async (id) => {
    try {
      const response = await axios.get(`https://fisiopilattes-production.up.railway.app/usuarios/solicitarDados/${id}`);
  ...
  const removerReserva = (id) => {
    if (window.confirm("Tem certeza que deseja remover esta reserva?")) {
      axios.delete(`https://fisiopilattes-production.up.railway.app/reservas/${id}`)
        .then(() => {
  ...
  const negarReserva = (reserva) => {
    ...
    axios.patch(`https://fisiopilattes-production.up.railway.app/reservas/negado/${reserva.id}`, { 
      status: 'negado', 
